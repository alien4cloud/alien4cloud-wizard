...
import {PaaSDeploymentStatusMonitorEvent} from "@app/core/models";
...
export class WebsocketClientService implements OnDestroy {
  ...
  constructor(private localStorage: LocalStorageService, @Inject(BOOTSTRAP_SETTINGS) private bootstrapSettings: BootstrapSettings) {

    let url = (bootstrapSettings.production) ? "../rest/alienEndPoint" : bootstrapSettings.urlPrefix + "../rest/w4cAlienEndPoint";
