...
import {PropertyDefinition, ScalarPropertyValue} from "../models/properties.model";
...
export class SettingsService extends GenericService {
  ...
  constructor(
    ...
    showFsmGrzph.enabled = !this.isProduction();
    ...
    fsmGraphHeight.enabled = !this.isProduction();
    ...
    fsmGraphWidth.enabled = !this.isProduction();
    ...
    fsmGraphZoomLevel.enabled = !this.isProduction();
